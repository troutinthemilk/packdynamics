...
```
According to AICc there is not much evidence for or against a nonlinear trend in these data. Getting data from before 2000 would be ideal for resolving this.
...
mod1 <- lm(Packs~ Size, data=Scandata)
mod2 <- lm(Packs~ Size + I(Size^2), data=Scandata)
mod3 <- lm(Packs~ Size + I(Size^2)-1, data=Scandata)
